...
import 'package:shoppingapp/screen/homepage_deals/blockbuster_deals_screen/blockbuster_deals_model.dart';
...
class BlockBusterDealsPage extends StatefulWidget {
  @override
  BlockBusterDealsPageState createState() => BlockBusterDealsPageState();
}

class BlockBusterDealsPageState extends State<BlockBusterDealsPage> {
  BlockBasterPageViewModel model;
  BlockbusterDealsFavoriteViewModel model1;
  ...
  Widget build(BuildContext context) {
    ...
    model ?? (model = BlockBasterPageViewModel(this));
    // ignore: unnecessary_statements
    model1 ?? (model1 = BlockbusterDealsFavoriteViewModel(this));

    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        iconTheme: IconThemeData(color: Colors.black),
        title: Text(Strings.blockbusterDeals,
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              child: model.homepage.blockbusterProducts == null
                  ? Container(
                ...
                itemCount:
                model.homepage.blockbusterProducts.data.length,
                itemBuilder: (BuildContext context, int index) {
                  qtyController = [];
                  List.generate(
                      model.homepage.blockbusterProducts.data.length, (index) =>
                      qtyController.add(TextEditingController()));
                  for (var i = 0;
                  i < bookOrderObj.productsInCart.length;
                  i++) {
                    if (model.homepage.blockbusterProducts
                        .data[index].ppProductId
                        .toString() ==
                        bookOrderObj.productsInCart[i].productID) {
                      cartListIndex = i;
                      qtyController[index]
                        ..text = bookOrderObj.productsInCart[cartListIndex]
  ...
  productTile(int index, themeColor, context) {
    return Container(
      child: InkWell(
        onTap: () async {
          ...
          for (var i = 0; i < bookOrderObj.productsInCart.length; i++) {
            if (bookOrderObj.productsInCart[i].productID ==
                model.homepage.blockbusterProducts.data[index].ppProductId
                    .toString()) {
              productIndex = i;
            }
          }
          ...
          var data = await Get.to(
                ...
                ProductDetailPage(
                  ...
                  productQty: productIndex == null
                      ...
                      .productQuantity,
                  stock: model.homepage.blockbusterProducts.data[index]
                      .qtyInCases,
                ),
          );
        ...
        child:
        // model.homepage.blockbusterProducts.data[index]
        //     .savedPercentage == 0 ?SizedBox():
        Container(
          ...
          child: Column(
            children: [
              Container(
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          model.homepage.blockbusterProducts.data[index]
                              .savedPercentage ==
                              null || model.homepage.blockbusterProducts
                              .data[index]
                              .savedPercentage == 0 ||model.homepage.blockbusterProducts
                              .data[index]
                            ...
                            child: Center(
                              child: Text(
                                (model.homepage.blockbusterProducts
                                    .data[index].savedPercentage
                                    .round()
                                    .toString() +
                                    '% ${Strings.off}'),
                                maxLines: 1,
                      ...
                      InkWell(
                        onTap: () {
                          if (model.homepage.blockbusterProducts
                            ...
                            setState(() {
                              model.homepage.blockbusterProducts
                                  .data[index].isinWishlist = 'inactive';
                            });
                            ...
                            setState(() {
                              model.homepage.blockbusterProducts
                                  .data[index].isinWishlist = 'active';
                            });
                            // ignore: deprecated_member_use
                            Scaffold.of(context).showSnackBar(
                              SnackBar(
                        ...
                        child: Icon(
                          Icons.favorite,
                          color: model.homepage.blockbusterProducts
                              .data[index].isinWishlist ==
                              'active'
                              ? Colors.red
                              : Colors.black,
                  ...
                  model.homepage.blockbusterProducts.data[index]
                    ...
                    style: GoogleFonts.poppins(
                      ...
                      : Text(
                    "${Strings.stock} ${model.homepage.blockbusterProducts
                        .data[index].qtyInCases}",
                    style: GoogleFonts.poppins(
                      color: Colors.grey[500],
                      fontWeight: FontWeight.w400,
                      fontSize: 13,
                  ...
                  model.homepage.blockbusterProducts.data[index]
                      ...
                      model.homepage.blockbusterProducts.data[index]
                          .qtyInCases == null ||
                      model.homepage.blockbusterProducts.data[index]
                          .qtyInCases == "null"?SizedBox(): Text(
                "${Strings.Quantityincase} ${model.homepage.blockbusterProducts
                    .data[index]
                    .qtyInCases
                    .toString()
                }", style: GoogleFonts.poppins(
              ...
              // model.homepage.blockbusterProducts.data[index].savedPercentage.toString() == "null"?SizedBox():
              Container(
                width: Get.width * 0.69,
                child:
                model.homepage.blockbusterProducts.data[index]
                    .savedAmount ==
                    null || model.homepage.blockbusterProducts.data[index]
                    .savedPercentage == "null" ||model.homepage.blockbusterProducts.data[index]
                    .savedPercentage == null ||model.homepage.blockbusterProducts.data[index]
                    .savedPercentage == 0
                    ? SizedBox()
                    :
              ...
              children: <Widget>[
                InkWell(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.poppins(
                      fontSize: 24,
                      color: showMBPrimaryColor ? millBornPrimaryColor : Colors
                          .white,
                    ),
                  ),
                ),
